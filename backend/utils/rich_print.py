...
def pretty_print_risk_evaluation_v2(공종, 공정, 작업명, 위험성평가표, 기타):
    console = Console()
    ...
    table = Table(show_header=True, header_style="bold magenta")
    table.add_column("번호", justify="center")
    table.add_column("공정세부분류", justify="center")
    table.add_column("유해위험요인", justify="center")
    table.add_column("사고분류", justify="left")
    table.add_column("위험가능성", justify="center")
    table.add_column("위험중대성", justify="center")
    table.add_column("위험성", justify="center")
    table.add_column("감소대책", justify="left")
    table.add_column("관련근거", justify="left")
...
__all__ = ["pretty_print_risk_evaluation", "pretty_print_risk_evaluation_v2"]